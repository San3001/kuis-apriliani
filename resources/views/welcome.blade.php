...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <img src="tia.png" alt="logo" width="50px">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
                            <img src="{{ asset('iLanding') }}/assets/img/illustration-1.webp" alt="Hero Image"
                                class="img-fluid">

                            <div class="customers-badge">
                                <div class="customer-avatars">
                                    <img src="{{ asset('iLanding') }}/assets/img/avatar-1.webp" alt="Customer 1"
                                        class="avatar">
                                    <img src="{{ asset('iLanding') }}/assets/img/avatar-2.webp" alt="Customer 2"
                                        class="avatar">
                                    <img src="{{ asset('iLanding') }}/assets/img/avatar-3.webp" alt="Customer 3"
                                        class="avatar">
                                    <img src="{{ asset('iLanding') }}/assets/img/avatar-4.webp" alt="Customer 4"
                                        class="avatar">
                                    <img src="{{ asset('iLanding') }}/assets/img/avatar-5.webp" alt="Customer 5"
                                        class="avatar">
                            ...
                            <div class="row gy-4">
                                <div class="col-lg-5">
                                    <div class="profile d-flex align-items-center gap-3">
                                        <img src="{{ asset('iLanding') }}/assets/img/avatar-1.webp" alt="CEO Profile"
                                            class="profile-image">
                                        <div>
                ...
                <div class="tab-content" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="tab-pane fade active show" id="features-tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('iLanding') }}/assets/img/features-illustration-1.webp"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="features-tab-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('iLanding') }}/assets/img/features-illustration-2.webp"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                    ...
                    <div class="tab-pane fade" id="features-tab-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('iLanding') }}/assets/img/features-illustration-3.webp"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
                        <div class="phone-mockup text-center">
                            <img src="{{ asset('iLanding') }}/assets/img/phone-app-screen.webp" alt="Phone Mockup"
                                class="img-fluid">
                        </div>
                ...
                "992": {
                  ...
                  "spaceBetween": 120
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-1.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-2.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-3.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-4.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-5.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-6.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-7.png"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('iLanding') }}/assets/img/clients/client-8.png"
                                class="img-fluid" alt=""></div>
                    </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="testimonial-item">
                            <img src="{{ asset('iLanding') }}/assets/img/testimonials/testimonials-1.jpg"
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="testimonial-item">
                            <img src="{{ asset('iLanding') }}/assets/img/testimonials/testimonials-2.jpg"
                                class="testimonial-img" alt="">
                            <h3>Sara Wilsson</h3>
                            <h4>Designer</h4>
                            <div class="stars">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="testimonial-item">
                            <img src="{{ asset('iLanding') }}/assets/img/testimonials/testimonials-3.jpg"
                                class="testimonial-img" alt="">
                            <h3>Jena Karlis</h3>
                            <h4>Store Owner</h4>
                            <div class="stars">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="testimonial-item">
                            <img src="{{ asset('iLanding') }}/assets/img/testimonials/testimonials-4.jpg"
                                class="testimonial-img" alt="">
                            <h3>Matt Brandon</h3>
                            <h4>Freelancer</h4>
                            <div class="stars">
